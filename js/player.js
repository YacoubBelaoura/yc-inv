    ...
    var _ = {
        ...
        init: function (options) {
            ...
            var template = ['<svg viewBox="0 0 100 100" id="playable" version="1.1" xmlns="http://www.w3.org/2000/svg" width="34" height="34" data-play="playable" class="not-started playable">',
                ...
                '<circle class="progress-bar" cx="50" cy="50" r="47.45" stroke="#7b2cbf" stroke-opacity="1" stroke-linecap="round" fill="none" stroke-width="5" transform="rotate(-90 50 50)"/>',
                '</g>',
                ...
                '<polygon points="45,35 65,50 45,65" fill="#c77dff" stroke-width="0"></polygon>',
                '</g>',
